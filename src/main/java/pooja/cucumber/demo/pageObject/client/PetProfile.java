...
//	
////	public final JSONObject employeeDetails2;
////	
////	PetProfile()
////	{
////		employeeDetails2 = new JSONObject();
////	test();
////	}
//
//
////    employeeDetails2.put("lblHeadingName", "//p[contains(@class,'css-1lc69kt')]");
////    employeeDetails2.put("lblAddPet","Schultz");
////    employeeDetails2.put("lblPriPetParent", "example.com");
//
////	public void test()
////	{
////		employeeDetails2.put("lblHeadingName", "//p[contains(@class,'css-1lc69kt')]");
////		employeeDetails2.get(lblHeadingName);
////	 System.out.println(employeeDetails2.get(lblHeadingName));
////	}
////	
//
//	public final String lblHeadingName = "//p[contains(@class,'css-1lc69kt')]";
//	public final String lblAddPet = "//p[contains(@class,'css-6ye8qf')]";
//	public final String lblPriPetParent = "//p[contains(@class,'css-41cdju')]";
//	public final String lblPetName = "//label[contains(@class,'css-uzkr03') and contains(text(),'Pet Name')]";
//	public final String lblPetUserName = "//label[contains(@class,'css-uzkr03') and contains(text(),'Pet Username')]";
//	public final String lblBirthDate = "//label[contains(@class,'css-uzkr03') and contains(text(),'Date of Birth ')]";
//	public final String lblAge = "//label[contains(@class,'css-uzkr03') and contains(text(),'Age ')]";
//	public final String lblAnimalType = "//label[contains(@class,'css-uzkr03') and contains(text(),'Animal ')]";
//	public final String lblGender = "//label[contains(@class,'css-uzkr03') and contains(text(),'Gender')]";
//	public final String lblPriBreed = "//label[contains(@class,'css-uzkr03') and contains(text(),'Primary Breed')]";
//	public final String lblSecBreed = "//label[contains(@class,'css-uzkr03') and contains(text(),'Secondary Breed')]";
//	public final String lblPetBio = "//label[contains(@class,'css-uzkr03') and contains(text(),'pet Bio')]";
//	public final String txtPetName = "//input[@id='name']";
//	public final String txtPetUserName = "//input[@id='username']";
//	public final String txtBirthdate = "//input[@id=':r38:']";
//	public final String txtAnimalType = "//input[@id=':r3a:']";
//	public final String txtPriBreed = "//input[@placeholder='primary breed']";
//	public final String txtSecBreed = "//input[@placeholder='secondary breed']";
//	public final String txtBio = "//textarea[@name='bio']";
//	public final String optFemale="//img[@alt='female']";
//	public final String optmale="//img[@alt='male']";
//	public final String btnCancel="//button[contains(@class,'css-1uod7k3')]";
//	public final String btnNext="	//button[contains(@class,'css-1bti7ya')]";
//	public final String btnSkip="//button[contains(@class,'css-n4taj4')]";
//	public final String SymolUploadImg="//div[@class='MuiBox-root css-t01zbk']//img";
//	
//	
//	
